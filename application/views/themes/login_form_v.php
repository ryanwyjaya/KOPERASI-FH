...
<head>
	<meta charset="UTF-8">
	<title>LOGIN-KOPERASI FHUP</title>
...
<body>
	...
	<div class="form-box" id="login-box">
		<div class="header"><img height='60' src="<?php echo base_url().'assets/theme_admin/img/up1-2.png'; ?>"></div>
		<center><H3><a>APLIKASI KOPERASI FHUP</a></H3></center>
		<form action="" method="post">
			...
			<div class="footer"> 
		<div align="center">&copy; Copyright <?php echo date('Y'); ?> |  FHUP. </div> 
			</div>
		</form>
	</div>
